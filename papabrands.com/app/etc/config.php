...
return [
    'modules' => [
        ...
        'Amasty_Amp' => 1,
        'Amasty_Base' => 1,
        'Amasty_ImportExportCore' => 0,
        'Amasty_ExportCore' => 0,
        'Amasty_MegaMenuLite' => 0,
        'Amasty_MegaMenu' => 0,
        'Amasty_Rma' => 1,
        'Amazon_Core' => 1,
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Beeapps_AttributesManagement' => 1,
        'Custom_PapaReferFriendBlock' => 1,
        'Dolphin_Walletrewardpoints' => 0,
        ...
        'Klarna_KpGraphQl' => 1,
        'LitExtension_MigrationToMagento' => 1,
        'Lof_All' => 1,
        'Lof_QtyDropdown' => 0,
        ...
        'Magecomp_Codmsg91' => 1,
        'Magecomp_Codtwilio' => 1,
        'Magecomp_Codbulksms' => 1,
        'Magecomp_Ordertracking' => 1,
        'Magedelight_Base' => 1,
        'Magedelight_OneStepCheckout' => 1,
        ...
        'RH_SlickSlider' => 1,
        'Rt_Customers' => 0,
        'Sebastian13_Bootstrap' => 1,
        'Softprodigy_Bluedart' => 1,
        'Sparsh_AjaxInfiniteScroll' => 0,
        'Sparsh_Faq' => 0,
        'Strategery_Infinitescroll' => 1,
        'Swissup_FontAwesome5' => 0,
        'Temando_ShippingRemover' => 1,
        'Vertex_Tax' => 1,
        'Vertex_AddressValidationApi' => 1,
        'Vertex_AddressValidation' => 1,
        'Vvasiloud_AutoRelatedProducts' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
